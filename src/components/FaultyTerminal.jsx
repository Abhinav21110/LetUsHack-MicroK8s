...
export default function FaultyTerminal({
	...
	useEffect(() => {
		...
		if (mouseReact) {
			...
			ctn.addEventListener("touchmove", handleMouseMove);
			ctn.addEventListener("touchstart", handleMouseMove);
		}
		...
		return () => {
			...
			if (mouseReact) {
				...
				ctn.removeEventListener("touchmove", handleMouseMove);
				ctn.removeEventListener("touchstart", handleMouseMove);
			}
